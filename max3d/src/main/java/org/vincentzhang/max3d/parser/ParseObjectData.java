...
import org.vincentzhang.max3d.animation.KeyFrame;
import org.vincentzhang.max3d.core.Object3d;
import org.vincentzhang.max3d.parser.AParser.BitmapAsset;
import org.vincentzhang.max3d.parser.AParser.Material;
import org.vincentzhang.max3d.parser.AParser.TextureAtlas;
import org.vincentzhang.max3d.vos.Color4;
import org.vincentzhang.max3d.vos.Face;
import org.vincentzhang.max3d.vos.Number3d;
import org.vincentzhang.max3d.vos.Uv;
    ...
    private void parseObject(Object3d obj, HashMap<String, Material> materialMap, TextureAtlas textureAtlas) {
        ...
        for (int i = 0; i < numFaces; i++) {
            ...
            for (int j = 0; j < face.faceLength; j++) {
                ...
                Uv newUv = face.hasuv && texCoords.size() > 0 ? texCoords.get(wrap(face.uv[j], texCoords.size())).clone()
                        : new Uv();
